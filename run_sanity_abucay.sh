#!/bin/bash
# ==============================================================
# DFSP Toggle Testing Checklist — Abucay Rural Bank
...
BASE_RESULT_DIR="${BASE_DIR}/results/Sanity_Abucay"
...
$ROBOT \
  ...
  -e ResetPassword \
  -e ExternalRCBC \
  --variable SBX_APP_PACKAGE:com.higala.bancoabucay \
  --variable SBX_EMAIL:jjavier+1@nmblr.ai \
  --variable SBX_PASSWORD:Password!1 \
  --variable SBX_SAME_BANK_RECIPIENT_ACCT:7710589946921181 \
  --variable "SBX_SAME_BANK_RECIPIENT_NAME:Peach Marie Villados" \
