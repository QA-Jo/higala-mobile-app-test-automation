#!/bin/bash
# ==============================================================
# DFSP Toggle Testing Checklist — Hermosa Rural Bank
...
# Sender:    Paulo Navarro — jjavier+29@nmblr.ai
# Recipient: JV            — 7710794016092030 (same-bank)
# RB-to-RB:  (TBD — fill in when cross-bank recipient is confirmed)
# ==============================================================
ROBOT=/Library/Frameworks/Python.framework/Versions/3.14/bin/robot
BASE_DIR="$(cd "$(dirname "$0")" && pwd)"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
BASE_RESULT_DIR="${BASE_DIR}/results/Sanity_Hermosa"
...
$ROBOT \
  ...
  -e Skipped \
  -e ResetPassword \
  --variable SBX_APP_PACKAGE:com.higala.ruralbankofhermosa \
  --variable SBX_EMAIL:jjavier+29@nmblr.ai \
  --variable "SBX_PASSWORD:Password!1" \
  --variable SBX_SAME_BANK_RECIPIENT_ACCT:7710794016092030 \
  --variable "SBX_SAME_BANK_RECIPIENT_NAME:JV" \
  ...
  --variable SBX_RB_RECIPIENT_ACCT:7710935377438751 \
  --variable "SBX_RB_RECIPIENT_NAME:Jocelyn Amban" \
